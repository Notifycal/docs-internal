...
1. Also set _Default commit message_ to _Pull request title_ (without description). "Weird" characters in the description will cause `release-please` to fail to create the release if it cannot parse the commit body.
